...
**目标**：定期维护知识库健康度，并检测架构违规、废弃代码，对抗 AI 辅助开发中的熵增。
...
| 场景说明质量 | 各文档前 5 行的场景说明是否足够精准，AI 是否能正确触发 |

**执行方式**：人工 Review + 让 AI 协助检查（提示词：「请检查 .ai/ 目录下的文档，找出可能已过时或不准确的内容」）
...
**待明确**：
- [ ] 每个知识库目录的具体维护责任人和流程
- [ ] 文档更新频率和审核机制（谁来 Review、合入标准）
- [ ] 与代码同步策略（代码 API 变更时如何同步触发文档更新）
